...
В JS для связных списков, да и вообще списков, используют <a href="https://learn.javascript.ru/object">объекты</a>. Один объект — это объект, много объектов вместе — список.

Но положить объект в объект недостаточно, чтобы список стал <b>связным</b>. Особенность этого списка в том, что каждый элемент списка является указателем на следующий элемент этого же списка. Получается цепочка элементов. 
...
Объект связан одной сущностью — блинами, но последовательных действий тут нет. Можно, конечно, пронумеровать некоторые ключи, написать алгоритм, который будет читать значения из них по порядку, но ведь с объектами так не работают, правда?
...
В самом JS тоже есть примеры связанных списков. Например, цепочка прототипов — связный список.
...
Ещё можно встретить название «связанный список», а в оригинале структура называется Linked list. Такой список так же можно назвать однонаправленным.
...
Не всякий список связный. Связным он становится именно тогда, каждый каждый элемент списка (он же <a href="https://learn.javascript.ru/object">объект</a>), кроме информации о себе, содержит ссылку на соседний элемент этого списка. В теории может быть непонятно, поэтому посмотрим примеры.
      
Любую последовательность действий можно записать в виде связного списка. Например, рецепта приготовления блинов.
...
Ещё можно встретить название «связанный список», а в оригинале структура называется Linked list. Такой список так же можно называть однонаправленным.
      
В JS для связных списков, да и вообще списков, используют <a href="https://learn.javascript.ru/object">объекты</a>. В общем-то обычный объект в JS и называют списком.
...
console.log(route['next']['next']['street']);</code></pre>
...
В <a href="https://pda.litres.ru/aditya-bhargava/grokaem-algoritmy-illustrirovannoe-posobie-dlya-p-39158380/?utm_source=google&utm_medium=cpc&utm_campaign=search_dsa_ohvat_f%7C2087774395&utm_term=&utm_content=433453034319%7Bphrase_id%7D_%7Bsource%7D_%7Bsource_type%7D_%7Bregion_name%7D_9051401&param_2=987239&gclid=EAIaIQobChMIrJ7Fi7Xw6wIVhPuyCh1aIgoeEAAYAyAAEgLki_D_BwE">книге «Грокаем алгоритмы»</a> приводится наглядный пример с кинотеатром. Представьте, что вы приходите в кино компанией друзей. Допустим, вас 7 человек. Вы хотите сесть все вместе, поэтому ищите 7 свободных мест рядышком. Кое-как места нашлись. Приходит ещё один ваш друг, а свободных мест рядом нет. И вам снова приходится искать места, чтобы вы все смогли сесть рядом. Примерно так выглядит выделение памяти для массива.`,
        anotherImage: './images/arrays.png',
        thirdText: `Представим теперь, что вы пришли той же компанией в кино. В зале нет 7 свободных мест рядом, поэтому вы рассаживаетесь, кто куда. При этом лично вам не надо запоминать кто где сидит. Вы можете запомнить, где сидит ваш друг Ваня, Ваня запомнит, где сидит Катя, и так далее. Так вы не потеряете друг друга и сможете посмотреть кино. Примерно так работает выделение памяти для списков, в частности связных.

Это не значит, что списки лучше массивов и стоит всегда использовать их. Всё зависит от задачи: для каждой у разных структур будут свои преимущества и недостатки. 
        
В следующих заданиях мы узнаем о ещё нескольких отличиях массивов и списков, а дальше потренируемся выбирать подходящую под задачу структуру данных.`
      }
    },
    {
      isCorrect: false,
      content: {
        ...
        thirdText: `В <a href="https://pda.litres.ru/aditya-bhargava/grokaem-algoritmy-illustrirovannoe-posobie-dlya-p-39158380/?utm_source=google&utm_medium=cpc&utm_campaign=search_dsa_ohvat_f%7C2087774395&utm_term=&utm_content=433453034319%7Bphrase_id%7D_%7Bsource%7D_%7Bsource_type%7D_%7Bregion_name%7D_9051401&param_2=987239&gclid=EAIaIQobChMIrJ7Fi7Xw6wIVhPuyCh1aIgoeEAAYAyAAEgLki_D_BwE">книге «Грокаем алгоритмы»</a> приводится наглядный пример с кинотеатром. Представьте, что вы приходите в кино компанией друзей. Допустим, вас 7 человек. Вы хотите сесть все вместе, поэтому ищите 7 свободных мест рядышком. Кое-как места нашлись. Приходит ещё один ваш друг, а свободных мест рядом нет. И вам снова приходится искать места, чтобы вы все смогли сесть рядом. Примерно так выглядит выделение памяти для массива.

Представим теперь, что вы пришли той же компанией в кино. В зале нет 7 свободных мест рядом, поэтому вы рассаживаетесь, кто куда. При этом лично вам не надо запоминать кто где сидит. Вы можете запомнить, где сидит ваш друг Ваня, Ваня запомнит, где сидит Катя, и так далее. Так вы не потеряете друг друга и сможете посмотреть кино. Примерно так работает выделение памяти для списков, в частности связанных списков.
...
При работе со списками новое место в памяти выделяется по мере ввода новых элементов. А так как объекты могут ссылаться друг на друга, как в связных списках, то новое место в памяти может быть, где угодно, элементам необязательно находиться в памяти рядом, ведь есть указатель на каждый элемент. Помните наш список с рецептом из прошлого задания?`,
        image: './images/lists.png',
        anotherText: `Нет, разница есть.

При работе со списками новое место в памяти выделяется по мере ввода новых элементов. А так как объекты могут ссылаться друг на друга, как в связных списках, то новое место в памяти может быть, где угодно, элементам необязательно находиться в памяти рядом, ведь есть указатель на каждый элемент. Помните наш список с рецептом из прошлого задания?`,
        anotherImage: './images/arrays.png',
        thirdText: `В <a href="https://pda.litres.ru/aditya-bhargava/grokaem-algoritmy-illustrirovannoe-posobie-dlya-p-39158380/?utm_source=google&utm_medium=cpc&utm_campaign=search_dsa_ohvat_f%7C2087774395&utm_term=&utm_content=433453034319%7Bphrase_id%7D_%7Bsource%7D_%7Bsource_type%7D_%7Bregion_name%7D_9051401&param_2=987239&gclid=EAIaIQobChMIrJ7Fi7Xw6wIVhPuyCh1aIgoeEAAYAyAAEgLki_D_BwE">книге «Грокаем алгоритмы»</a> приводится наглядный пример с кинотеатром. Представьте, что вы приходите в кино компанией друзей. Допустим, вас 7 человек. Вы хотите сесть все вместе, поэтому ищите 7 свободных мест рядышком. Кое-как места нашлись. Приходит ещё один ваш друг, а свободных мест рядом нет. И вам снова приходится искать места, чтобы вы все смогли сесть рядом. Примерно так выглядит выделение памяти для массива.

Представим теперь, что вы пришли той же компанией в кино. В зале нет 7 свободных мест рядом, поэтому вы рассаживаетесь, кто куда. При этом лично вам не надо запоминать кто где сидит. Вы можете запомнить, где сидит ваш друг Ваня, Ваня запомнит, где сидит Катя, и так далее. Так вы не потеряете друг друга и сможете посмотреть кино. Примерно так работает выделение памяти для списков, в частности связанных.
  ...
  '11': [
    {
      isCorrect: false,
      content: {
        text: `Нет. Вставка нового элемента в массив дороже, чем вставка в список. Помните, в списках каждый элемент хранит ссылку на следующий? Да и в памяти элементы могут лежать кто где. Чтобы добавить новый элемент в список, достаточно в одном месте поменять ссылку на него.
...
// И зададим следующий элемент объекту с солью, чтобы список продолжился
...
В памяти просто появилась ссылка на ещё один объект.
...
С удалением всё точно так же. В списке мы просто убираем ссылку на объект и всё. А в массиве удалённый элемент надо убрать, передвинуть все элементы (кто-то ведь должен занять пустующее место), пересчитать все индексы. Поэтому добавление и удаление элементов в списках проще с точки зрения памяти. Это происходит быстро, без большого количества операций.`
    ...
    },
    {
      isCorrect: true,
      content: {
        text: `Да! Вставка нового элемента в массив дороже, чем вставка в список. Помните, в списках каждый элемент хранит ссылку на следующий? Да и в памяти элементы могут лежать кто где. Чтобы добавить новый элемент в список, достаточно в одном месте поменять ссылку на него.
...
В памяти просто появилась ссылка ещё на один объект.
...
Вставка нового элемента в массив дороже, чем вставка в список. Помните, в списках каждый элемент хранит ссылку на следующий? Да и в памяти элементы могут лежать кто где. Чтобы добавить новый элемент в список, достаточно в одном месте поменять ссылку на него.
...
В программировании нет правильных ответов. Решить задачу можно разными способами. А принятие решение — ответственность разработчика.`
      }
    },
    {
      isCorrect: true,
...
На самом деле для этой задачи можно использовать и массивы. У них, например, есть встроенные методы добавления элементов. Да, добавление элементов в массив дороже, чем добавление в список, зато не придётся придумывать свой собственный метод для добавления заказов в конец. В программировании нет правильных ответов. Решить задачу можно разными способами. А принятие решение — ответственность разработчика.`
      }
    },
    {
      isCorrect: true,
...
Поэтому тут нет единственного верного ответа, многое зависит от дополнительных фич. Решение за разработчиком.`
    ...
    },
    {
      isCorrect: false,
      content: {
        text: `Попробуем разобраться!

Нам не нужно внезапно получать ноту из середины мелодии, добавлять и удалять элементы, мы просто пойдём по порядку, нота за нотой. Поэтому список с указанием на следующую ноту подойдёт. Достаточно будет написать простенький итератор с условием типа 
<code>while (current. next) { // код итератора }</code> 
и ноты будут проигрываться.
...
Вы пишите приложение для ресторана. Официант принимает заказ через приложение, заказ добавляется в конец очереди, повар берёт первый заказ из очереди и начинает готовить. Что подойдёт больше для реализации приложения — массив или связный список?`,
  ...
  actions: {
    checkAnswer: async ({ setState, state, edit, argument, send }) => {
      ...
      console.log(answer.content.image);
      ...
      if (answer.content.anotherText) {
        await send({
          message: answer.content.anotherText,
        });
      } else if (answer.content.anotherImage) {
        await send({
          message: answer.content.anotherText,
      ...
      if (answer.content.thirdText) {
        await send({
          message: answer.content.thirdText
        });
      }
