...
В JS для связных списков, да и вообще списков, используют <a href="https://learn.javascript.ru/object">объекты</a>. Много объектов вместе — список.

Но положить объект в объект недостаточно, чтобы список стал <b>связным</b>. Особенность этого списка в том, что каждый элемент является указателем на следующий элемент этого же списка. Получается цепочка элементов. 
...
Положить объект в объект недостаточно, чтобы список стал <b>связным</b>. Особенность этого списка в том, что каждый элемент является указателем на следующий элемент этого же списка. Получается цепочка элементов. 
