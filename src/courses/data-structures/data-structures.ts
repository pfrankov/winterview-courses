...
export default {
  ...
  description: () => {
    return [
      ...
      'Узнаете, какие бывают структуры, для чего используются, научитесь базовым операциям со структурами.',
      'Если вы совсем новичок, вам как раз сюда!',
      '',
      'Курс сделан в формате теста и идёт неделю, каждый день вам будет приходить новый вопрос. Вам нужно будет выбрать вариант ответа. Нестрашно, если ошибётесь. В любом случае вы получите подробное объяснение и узнаете правильный ответ.',
      '',
      'Погнали!',
      '',
      '',
